...
class VisualIvrNewFiles extends BaseOperation {
  constructor(props) {
    super(props);
    this.name = 'Visual IVR New Files indexer';
    this.logTable = 'pagamento_online_idcontratto_cf';
    this.confCollection = 'configurations';
    this.targetCollection = 'visualivr';
    // this.searchString = 'Codice verificato per record %';
    this.confName = 'visualIvrNewFilesIndexer';
    // this.dateColumn = 'updatetime';
    this.mainProp = 'newFiles';
    this.delay = 30000;
...
export default VisualIvrNewFiles;
