...
var VisualIvrSessions = function (_BaseOperation) {
  ...
  function VisualIvrSessions(props) {
    ...
    _this.name = 'Visual IVR Verified Codes indexer';
    _this.logTable = 'online_payment_logs';
    _this.confCollection = 'configurations';
    _this.targetCollection = 'visualivr';
    _this.searchString = 'Codice verificato per record %';
    _this.confName = 'visualIvrVerifiedCodes';
    _this.mainProp = 'verifiedCodes';
    _this.delay = 20000;
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(VisualIvrSessions, 'VisualIvrSessions', 'api-src/timedoperations/VisualIvrCodeVerified.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'api-src/timedoperations/VisualIvrCodeVerified.js');
}();
