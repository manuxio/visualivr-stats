...
var VisualIvrCompletedPayments = function (_BaseOperation) {
  _inherits(VisualIvrCompletedPayments, _BaseOperation);

  function VisualIvrCompletedPayments(props) {
    _classCallCheck(this, VisualIvrCompletedPayments);

    var _this = _possibleConstructorReturn(this, (VisualIvrCompletedPayments.__proto__ || Object.getPrototypeOf(VisualIvrCompletedPayments)).call(this, props));

    _this.name = 'Visual IVR Completed Payments indexer';
    ...
    _this.confName = 'visualIvrCompletedPaymentTransactionsIndexer';
    _this.dateColumn = 'updatetime';
    _this.mainProp = 'paymentCompleted';
    _this.delay = 30000;
  ...
  _createClass(VisualIvrCompletedPayments, [{
  ...
  return VisualIvrCompletedPayments;
}(_baseOperation2.default);

var _default = VisualIvrCompletedPayments;
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(VisualIvrCompletedPayments, 'VisualIvrCompletedPayments', 'api-src/timedoperations/VisualIvrCompletedPayments.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'api-src/timedoperations/VisualIvrCompletedPayments.js');
}();
